...
* [Insomnia](https://insomnia.rest/) (o cualquier cliente REST). Una herramienta muy útil puede ser [postman](https://www.getpostman.com/)
...
Vagrant toma imágenes de un repositorio centralizado (Atlas). Lo cómodo de Vagrant es que se configura el ambiente con un archivo muy sencillo (`.Vagrant`).
...
```
Si todo está bien, encontrará una carperta `Fiware` y dentro de ésta, tres carpetas más.  Verifique que se han copiado las carpetas en su computadora.  Revise el contenido de la carpeta `vm-fiware-orion`. Debe tener el archivo de configuración `Vagrantfile` y un archivo `init.sh` el cual tiene una serie de comandos que se ejecutarán al levantar vagrant y que ayudan a configurar el ambiente.
...
$ ll
total 4
drwxr-xr-x 1 fwuser 1049089    0 nov 21 09:45 MD/
-rw-r--r-- 1 fwuser 1049089 1553 nov 21 09:45 README.md
drwxr-xr-x 1 fwuser 1049089    0 nov 21 09:45 vm-fiware-consumer/
drwxr-xr-x 1 fwuser 1049089    0 nov 21 09:45 vm-fiware-orion/

$ ll vm-fiware-orion/
total 8
-rw-r--r-- 1 JINCERAD 1049089 2713 nov 21 09:45 init.sh
-rw-r--r-- 1 JINCERAD 1049089 3632 nov 21 09:45 Vagrantfile
...
En el archivo vemos que se instalarán Orion y mongoDB y ahí se define cómo se comunican entre ellos. 
...
fiware-sdk:~
```
**¡FELICIDADES!** En el tutorial aprenderemos a interactuar con el OCB desde una aplicación REST.
